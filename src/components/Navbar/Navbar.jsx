      ...
      <div >
        ...
        <nav className="nav_mainBackground">
          <div className="nav_leftDiv">
            <div>
              <img
                src="https://media.tenor.com/LSHKMiRdLggAAAAj/statistics-trending-up.gif"
                alt=""
              />
              <h2 style={{color:"white"}}>Kanban Board</h2>
            </div>

            {stared ? (
              <p onClick={() => setStared(false)}>
                <HiStar />
              </p>
            ) : (
              <p onClick={() => setStared(true)}>
                <IoIosStarOutline />
              </p>
            )}
          ...
          <div className="nav_rightDiv">
            <p onClick={handleClear}>
              <HiOutlineRocketLaunch /> &nbsp; Clean-Ups
            </p>
            {/* <p><HiBolt/> &nbsp; Automation</p> */}
            <p onClick={() => navigate("/background")}>
              <HiBars3BottomLeft /> &nbsp; Background
            </p>
          </div>
        </nav>
      </div>
